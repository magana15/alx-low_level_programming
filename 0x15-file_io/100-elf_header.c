 ...
 *
 * Description: Magic number are separated by a space.
 */
void print_magic(unsigned char *e_ident)
{
	int index;
...
/**
 * main - Display the information contained in ELF header at start of ELF file.
 ...
 * the function is a fail - exit code 98.
 */
